...
#define TYPE_FORMAT_STRING_SIZE   1393                              
#define PROC_FORMAT_STRING_SIZE   1457                              
#define EXPR_FORMAT_STRING_SIZE   29                                
#define TRANSMIT_AS_TABLE_SIZE    0            
#define WIRE_MARSHAL_TABLE_SIZE   0            

typedef struct _nspi_MIDL_TYPE_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ TYPE_FORMAT_STRING_SIZE ];
    } nspi_MIDL_TYPE_FORMAT_STRING;

typedef struct _nspi_MIDL_PROC_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ PROC_FORMAT_STRING_SIZE ];
    } nspi_MIDL_PROC_FORMAT_STRING;

typedef struct _nspi_MIDL_EXPR_FORMAT_STRING
    {
    long          Pad;
    unsigned char  Format[ EXPR_FORMAT_STRING_SIZE ];
    } nspi_MIDL_EXPR_FORMAT_STRING;


static const RPC_SYNTAX_IDENTIFIER  _RpcTransferSyntax = 
{{0x8A885D04,0x1CEB,0x11C9,{0x9F,0xE8,0x08,0x00,0x2B,0x10,0x48,0x60}},{2,0}};

extern const nspi_MIDL_TYPE_FORMAT_STRING nspi__MIDL_TypeFormatString;
extern const nspi_MIDL_PROC_FORMAT_STRING nspi__MIDL_ProcFormatString;
extern const nspi_MIDL_EXPR_FORMAT_STRING nspi__MIDL_ExprFormatString;

/* Standard interface: __MIDL_itf_nspi_0000_0000, ver. 0.0,
...
extern const MIDL_SERVER_INFO nspi_ServerInfo;

extern const RPC_DISPATCH_TABLE nspi_v56_0_DispatchTable;

static const RPC_SERVER_INTERFACE nspi___RpcServerInterface =
    {
    sizeof(RPC_SERVER_INTERFACE),
    {{0xF5CC5A18,0x4264,0x101A,{0x8C,0x59,0x08,0x00,0x2B,0x2F,0x84,0x26}},{56,0}},
    {{0x8A885D04,0x1CEB,0x11C9,{0x9F,0xE8,0x08,0x00,0x2B,0x10,0x48,0x60}},{2,0}},
    (RPC_DISPATCH_TABLE*)&nspi_v56_0_DispatchTable,
    0,
    0,
    0,
    &nspi_ServerInfo,
...
RPC_IF_HANDLE nspi_v56_0_s_ifspec = (RPC_IF_HANDLE)& nspi___RpcServerInterface;
...
static const nspi_MIDL_PROC_FORMAT_STRING nspi__MIDL_ProcFormatString =
    {
        0,
        {
...
/* 1044 */	NdrFcShort( 0x14 ),	/* x86 Stack size/offset = 20 */
/* 1046 */	0x30,		/* FC_BIND_CONTEXT */
			0x40,		/* Ctxt flags:  in, */
/* 1048 */	NdrFcShort( 0x0 ),	/* x86 Stack size/offset = 0 */
/* 1050 */	0x0,		/* 0 */
			0x0,		/* 0 */
/* 1052 */	NdrFcShort( 0x34 ),	/* 52 */
/* 1054 */	NdrFcShort( 0x8 ),	/* 8 */
/* 1056 */	0x46,		/* Oi2 Flags:  clt must size, has return, has ext, */
			0x5,		/* 5 */
/* 1058 */	0x8,		/* 8 */
			0x45,		/* Ext Flags:  new corr desc, srv corr check, has range on conformance */
...
/* 1070 */	NdrFcShort( 0x38 ),	/* Type Offset=56 */
...
/* 1088 */	NdrFcShort( 0x21c ),	/* Type Offset=540 */
...
/* 1130 */	NdrFcShort( 0x38 ),	/* Type Offset=56 */
...
/* 1144 */	NdrFcShort( 0x2013 ),	/* Flags:  must size, must free, out, srv alloc size=8 */
/* 1146 */	NdrFcShort( 0xc ),	/* x86 Stack size/offset = 12 */
/* 1148 */	NdrFcShort( 0x46a ),	/* Type Offset=1130 */
...
/* 1154 */	0x8,		/* FC_LONG */
	...
	/* Procedure NspiGetNamesFromIDs */

/* 1156 */	0x0,		/* 0 */
			0x48,		/* Old Flags:  */
/* 1158 */	NdrFcLong( 0x0 ),	/* 0 */
/* 1162 */	NdrFcShort( 0x11 ),	/* 17 */
/* 1164 */	NdrFcShort( 0x1c ),	/* x86 Stack size/offset = 28 */
/* 1166 */	0x30,		/* FC_BIND_CONTEXT */
			0x40,		/* Ctxt flags:  in, */
/* 1168 */	NdrFcShort( 0x0 ),	/* x86 Stack size/offset = 0 */
/* 1170 */	0x0,		/* 0 */
			0x0,		/* 0 */
/* 1172 */	NdrFcShort( 0x70 ),	/* 112 */
...
/* 1186 */	NdrFcShort( 0x8 ),	/* Flags:  in, */
/* 1188 */	NdrFcShort( 0x0 ),	/* x86 Stack size/offset = 0 */
/* 1190 */	NdrFcShort( 0x38 ),	/* Type Offset=56 */
...
/* 1198 */	NdrFcShort( 0xa ),	/* Flags:  must free, in, */
/* 1200 */	NdrFcShort( 0x8 ),	/* x86 Stack size/offset = 8 */
/* 1202 */	NdrFcShort( 0x14 ),	/* Type Offset=20 */

	/* Parameter pPropTags */

/* 1204 */	NdrFcShort( 0xb ),	/* Flags:  must size, must free, in, */
/* 1206 */	NdrFcShort( 0xc ),	/* x86 Stack size/offset = 12 */
/* 1208 */	NdrFcShort( 0x64 ),	/* Type Offset=100 */
...
/* 1214 */	NdrFcShort( 0x46a ),	/* Type Offset=1130 */

	/* Parameter ppNames */

/* 1216 */	NdrFcShort( 0x2013 ),	/* Flags:  must size, must free, out, srv alloc size=8 */
/* 1218 */	NdrFcShort( 0x14 ),	/* x86 Stack size/offset = 20 */
/* 1220 */	NdrFcShort( 0x4c2 ),	/* Type Offset=1218 */
...
/* 1226 */	0x8,		/* FC_LONG */
	...
	/* Procedure NspiGetIDsFromNames */

/* 1228 */	0x0,		/* 0 */
			0x48,		/* Old Flags:  */
/* 1230 */	NdrFcLong( 0x0 ),	/* 0 */
/* 1234 */	NdrFcShort( 0x12 ),	/* 18 */
/* 1236 */	NdrFcShort( 0x1c ),	/* x86 Stack size/offset = 28 */
/* 1238 */	0x30,		/* FC_BIND_CONTEXT */
			0x40,		/* Ctxt flags:  in, */
/* 1240 */	NdrFcShort( 0x0 ),	/* x86 Stack size/offset = 0 */
/* 1242 */	0x0,		/* 0 */
			0x0,		/* 0 */
/* 1244 */	NdrFcShort( 0x3c ),	/* 60 */
/* 1246 */	NdrFcShort( 0x8 ),	/* 8 */
/* 1248 */	0x47,		/* Oi2 Flags:  srv must size, clt must size, has return, has ext, */
			0x7,		/* 7 */
/* 1250 */	0x8,		/* 8 */
			0x47,		/* Ext Flags:  new corr desc, clt corr check, srv corr check, has range on conformance */
...
/* 1262 */	NdrFcShort( 0x38 ),	/* Type Offset=56 */
...
/* 1274 */	0x8,		/* FC_LONG */
	...
	/* Parameter cPropNames */

/* 1276 */	NdrFcShort( 0x88 ),	/* Flags:  in, by val, */
/* 1278 */	NdrFcShort( 0xc ),	/* x86 Stack size/offset = 12 */
/* 1280 */	NdrFcShort( 0x500 ),	/* 1280 */

	/* Parameter pNames */

/* 1282 */	NdrFcShort( 0x10b ),	/* Flags:  must size, must free, in, simple ref, */
/* 1284 */	NdrFcShort( 0x10 ),	/* x86 Stack size/offset = 16 */
/* 1286 */	NdrFcShort( 0x50e ),	/* Type Offset=1294 */

	/* Parameter ppPropTags */

/* 1288 */	NdrFcShort( 0x2013 ),	/* Flags:  must size, must free, out, srv alloc size=8 */
/* 1290 */	NdrFcShort( 0x14 ),	/* x86 Stack size/offset = 20 */
/* 1292 */	NdrFcShort( 0x46a ),	/* Type Offset=1130 */

	/* Return value */

/* 1294 */	NdrFcShort( 0x70 ),	/* Flags:  out, return, base type, */
/* 1296 */	NdrFcShort( 0x18 ),	/* x86 Stack size/offset = 24 */
/* 1298 */	0x8,		/* FC_LONG */
			0x0,		/* 0 */
...
/* 1306 */	NdrFcShort( 0x13 ),	/* 19 */
/* 1308 */	NdrFcShort( 0x20 ),	/* x86 Stack size/offset = 32 */
/* 1310 */	0x30,		/* FC_BIND_CONTEXT */
			0x40,		/* Ctxt flags:  in, */
/* 1312 */	NdrFcShort( 0x0 ),	/* x86 Stack size/offset = 0 */
/* 1314 */	0x0,		/* 0 */
			0x0,		/* 0 */
/* 1316 */	NdrFcShort( 0x74 ),	/* 116 */
...
/* 1334 */	NdrFcShort( 0x38 ),	/* Type Offset=56 */

	/* Parameter Reserved */

/* 1336 */	NdrFcShort( 0x48 ),	/* Flags:  in, base type, */
/* 1338 */	NdrFcShort( 0x4 ),	/* x86 Stack size/offset = 4 */
/* 1340 */	0x8,		/* FC_LONG */
			0x0,		/* 0 */
...
/* 1346 */	NdrFcShort( 0x6 ),	/* Type Offset=6 */

	/* Parameter pPropTags */

/* 1348 */	NdrFcShort( 0xb ),	/* Flags:  must size, must free, in, */
/* 1350 */	NdrFcShort( 0xc ),	/* x86 Stack size/offset = 12 */
/* 1352 */	NdrFcShort( 0x64 ),	/* Type Offset=100 */

	/* Parameter paStr */

/* 1354 */	NdrFcShort( 0x10b ),	/* Flags:  must size, must free, in, simple ref, */
/* 1356 */	NdrFcShort( 0x10 ),	/* x86 Stack size/offset = 16 */
/* 1358 */	NdrFcShort( 0x4a0 ),	/* Type Offset=1184 */

	/* Parameter ppMIds */

/* 1360 */	NdrFcShort( 0x2013 ),	/* Flags:  must size, must free, out, srv alloc size=8 */
/* 1362 */	NdrFcShort( 0x14 ),	/* x86 Stack size/offset = 20 */
/* 1364 */	NdrFcShort( 0x46a ),	/* Type Offset=1130 */

	/* Parameter ppRows */

/* 1366 */	NdrFcShort( 0x2013 ),	/* Flags:  must size, must free, out, srv alloc size=8 */
/* 1368 */	NdrFcShort( 0x18 ),	/* x86 Stack size/offset = 24 */
/* 1370 */	NdrFcShort( 0x96 ),	/* Type Offset=150 */

	/* Return value */

/* 1372 */	NdrFcShort( 0x70 ),	/* Flags:  out, return, base type, */
/* 1374 */	NdrFcShort( 0x1c ),	/* x86 Stack size/offset = 28 */
/* 1376 */	0x8,		/* FC_LONG */
			0x0,		/* 0 */
...
/* 1384 */	NdrFcShort( 0x14 ),	/* 20 */
/* 1386 */	NdrFcShort( 0x20 ),	/* x86 Stack size/offset = 32 */
/* 1388 */	0x30,		/* FC_BIND_CONTEXT */
			0x40,		/* Ctxt flags:  in, */
/* 1390 */	NdrFcShort( 0x0 ),	/* x86 Stack size/offset = 0 */
/* 1392 */	0x0,		/* 0 */
			0x0,		/* 0 */
/* 1394 */	NdrFcShort( 0x74 ),	/* 116 */
...
/* 1408 */	NdrFcShort( 0x8 ),	/* Flags:  in, */
/* 1410 */	NdrFcShort( 0x0 ),	/* x86 Stack size/offset = 0 */
/* 1412 */	NdrFcShort( 0x38 ),	/* Type Offset=56 */
...
/* 1420 */	NdrFcShort( 0x10a ),	/* Flags:  must free, in, simple ref, */
/* 1422 */	NdrFcShort( 0x8 ),	/* x86 Stack size/offset = 8 */
/* 1424 */	NdrFcShort( 0x6 ),	/* Type Offset=6 */

	/* Parameter pPropTags */

/* 1426 */	NdrFcShort( 0xb ),	/* Flags:  must size, must free, in, */
/* 1428 */	NdrFcShort( 0xc ),	/* x86 Stack size/offset = 12 */
/* 1430 */	NdrFcShort( 0x64 ),	/* Type Offset=100 */

	/* Parameter paWStr */

/* 1432 */	NdrFcShort( 0x10b ),	/* Flags:  must size, must free, in, simple ref, */
/* 1434 */	NdrFcShort( 0x10 ),	/* x86 Stack size/offset = 16 */
/* 1436 */	NdrFcShort( 0x566 ),	/* Type Offset=1382 */

	/* Parameter ppMIds */

/* 1438 */	NdrFcShort( 0x2013 ),	/* Flags:  must size, must free, out, srv alloc size=8 */
/* 1440 */	NdrFcShort( 0x14 ),	/* x86 Stack size/offset = 20 */
/* 1442 */	NdrFcShort( 0x46a ),	/* Type Offset=1130 */

	/* Parameter ppRows */

/* 1444 */	NdrFcShort( 0x2013 ),	/* Flags:  must size, must free, out, srv alloc size=8 */
/* 1446 */	NdrFcShort( 0x18 ),	/* x86 Stack size/offset = 24 */
/* 1448 */	NdrFcShort( 0x96 ),	/* Type Offset=150 */

	/* Return value */

/* 1450 */	NdrFcShort( 0x70 ),	/* Flags:  out, return, base type, */
/* 1452 */	NdrFcShort( 0x1c ),	/* x86 Stack size/offset = 28 */
/* 1454 */	0x8,		/* FC_LONG */
			0x0,		/* 0 */
...
static const nspi_MIDL_TYPE_FORMAT_STRING nspi__MIDL_TypeFormatString =
    {
        0,
        {
			NdrFcShort( 0x0 ),	/* 0 */
...
/* 1222 */	
			0x12, 0x0,	/* FC_UP */
/* 1224 */	NdrFcShort( 0x1c ),	/* Offset= 28 (1252) */
/* 1226 */	
			0x1b,		/* FC_CARRAY */
			0x3,		/* 3 */
/* 1228 */	NdrFcShort( 0xc ),	/* 12 */
/* 1230 */	0x9,		/* Corr desc: FC_ULONG */
			0x0,		/*  */
/* 1232 */	NdrFcShort( 0xfffc ),	/* -4 */
/* 1234 */	NdrFcShort( 0x11 ),	/* Corr flags:  early, */
/* 1236 */	0x1 , /* correlation range */
			0x0,		/* 0 */
/* 1238 */	NdrFcLong( 0x0 ),	/* 0 */
/* 1242 */	NdrFcLong( 0x186a0 ),	/* 100000 */
/* 1246 */	0x4c,		/* FC_EMBEDDED_COMPLEX */
			0x0,		/* 0 */
/* 1248 */	NdrFcShort( 0xff74 ),	/* Offset= -140 (1108) */
/* 1250 */	0x5c,		/* FC_PAD */
			0x5b,		/* FC_END */
/* 1252 */	
			0x18,		/* FC_CPSTRUCT */
...
/* 1272 */	0x12, 0x0,	/* FC_UP */
/* 1274 */	NdrFcShort( 0xfb24 ),	/* Offset= -1244 (30) */
/* 1276 */	
			0x5b,		/* FC_END */
...
/* 1298 */	0x29,		/* Corr desc:  parameter, FC_ULONG */
			0x0,		/*  */
/* 1300 */	NdrFcShort( 0xc ),	/* x86 Stack size/offset = 12 */
/* 1302 */	NdrFcShort( 0x11 ),	/* Corr flags:  early, */
/* 1304 */	0x1 , /* correlation range */
			0x0,		/* 0 */
/* 1306 */	NdrFcLong( 0x0 ),	/* 0 */
/* 1310 */	NdrFcLong( 0x186a0 ),	/* 100000 */
/* 1314 */	
			0x4b,		/* FC_PP */
			0x5c,		/* FC_PAD */
/* 1316 */	
...
/* 1328 */	0x12, 0x0,	/* FC_UP */
/* 1330 */	NdrFcShort( 0xff22 ),	/* Offset= -222 (1108) */
/* 1332 */	
			0x5b,		/* FC_END */
...
/* 1336 */	
			0x11, 0x0,	/* FC_RP */
/* 1338 */	NdrFcShort( 0x2c ),	/* Offset= 44 (1382) */
/* 1340 */	
			0x1b,		/* FC_CARRAY */
			0x3,		/* 3 */
/* 1342 */	NdrFcShort( 0x4 ),	/* 4 */
/* 1344 */	0x9,		/* Corr desc: FC_ULONG */
			0x0,		/*  */
/* 1346 */	NdrFcShort( 0xfffc ),	/* -4 */
/* 1348 */	NdrFcShort( 0x11 ),	/* Corr flags:  early, */
/* 1350 */	0x1 , /* correlation range */
			0x0,		/* 0 */
/* 1352 */	NdrFcLong( 0x0 ),	/* 0 */
/* 1356 */	NdrFcLong( 0x186a0 ),	/* 100000 */
/* 1360 */	
			0x4b,		/* FC_PP */
			0x5c,		/* FC_PAD */
/* 1362 */	
...
/* 1386 */	NdrFcShort( 0xffd2 ),	/* Offset= -46 (1340) */
...
static const nspi_MIDL_EXPR_FORMAT_STRING nspi__MIDL_ExprFormatString =
    {
        0,
        {
			0x4,		/* FC_EXPR_OPER */
...
static const unsigned short nspi__MIDL_ExprFormatStringOffsetTable[] =
{
0,
20,
};

static const NDR_EXPR_DESC  nspi_ExprDesc = 
 {
nspi__MIDL_ExprFormatStringOffsetTable,
nspi__MIDL_ExprFormatString.Format
};
...
static const MIDL_STUB_DESC nspi_StubDesc = 
    {
    (void *)& nspi___RpcServerInterface,
    MIDL_user_allocate,
    MIDL_user_free,
    0,
    RundownRoutines,
    ...
    0,
    0,
    nspi__MIDL_TypeFormatString.Format,
...
static const RPC_DISPATCH_FUNCTION nspi_table[] =
    {
    NdrServerCall2,
    NdrServerCall2,
    NdrServerCall2,
...
static const RPC_DISPATCH_TABLE nspi_v56_0_DispatchTable = 
    {
    21,
    (RPC_DISPATCH_FUNCTION*)nspi_table
    };

static const SERVER_ROUTINE nspi_ServerRoutineTable[] = 
    {
    (SERVER_ROUTINE)NspiBind,
    (SERVER_ROUTINE)NspiUnbind,
    (SERVER_ROUTINE)NspiUpdateStat,
    (SERVER_ROUTINE)NspiQueryRows,
    (SERVER_ROUTINE)NspiSeekEntries,
    (SERVER_ROUTINE)NspiGetMatches,
    (SERVER_ROUTINE)NspiResortRestriction,
    (SERVER_ROUTINE)NspiDNToMId,
    (SERVER_ROUTINE)NspiGetPropList,
    (SERVER_ROUTINE)NspiGetProps,
    (SERVER_ROUTINE)NspiCompareMIds,
    (SERVER_ROUTINE)NspiModProps,
    (SERVER_ROUTINE)NspiGetSpecialTable,
    (SERVER_ROUTINE)NspiGetTemplateInfo,
    (SERVER_ROUTINE)NspiModLinkAtt,
    (SERVER_ROUTINE)Opnum15NotUsedOnWire,
    (SERVER_ROUTINE)NspiQueryColumns,
    (SERVER_ROUTINE)NspiGetNamesFromIDs,
    (SERVER_ROUTINE)NspiGetIDsFromNames,
    (SERVER_ROUTINE)NspiResolveNames,
    (SERVER_ROUTINE)NspiResolveNamesW
    };

static const MIDL_SERVER_INFO nspi_ServerInfo = 
    {
    &nspi_StubDesc,
    nspi_ServerRoutineTable,
    nspi__MIDL_ProcFormatString.Format,
    nspi_FormatStringOffsetTable,
    0,
    0,
    0,
    0};
